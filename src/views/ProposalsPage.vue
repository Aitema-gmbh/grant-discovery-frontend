  ...
  <AppLayout>
    <div class="mb-8 animate-fade-in">
      <div class="flex justify-between items-center">
        <div>
          <h1 class="text-display-sm font-display text-navy-900 mb-2">My Proposals</h1>
          <p class="text-navy-600">Manage your grant proposals and track submission status</p>
        </div>
      </div>
    </div>
    ...
    <div v-if="loading" class="space-y-4">
      <div v-for="i in 4" :key="i" class="card-premium animate-pulse">
        ...
        <div class="h-4 bg-navy-100 rounded w-1/3"></div>
      </div>
    </div>
    ...
    <div v-else class="text-center py-16">
      ...
      <h3 class="text-2xl font-display font-semibold text-navy-900 mb-2">No proposals yet</h3>
      <p class="text-navy-600 mb-6 max-w-md mx-auto">
        Start a proposal by finding a matching grant and clicking "Create Proposal".
      </p>
