  ...
  <AppLayout>
    <div class="mb-8 animate-fade-in">
      <div class="flex justify-between items-center">
        <div>
          <h1 class="text-display-sm font-display text-navy-900 mb-2">My Organizations</h1>
          <p class="text-navy-600">Manage your CSO profiles and see matched grants</p>
        </div>
    ...
    <div v-if="loading" class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div v-for="i in 4" :key="i" class="card-premium animate-pulse">
        <div class="h-6 bg-navy-200 rounded w-3/4 mb-4"></div>
        <div class="h-4 bg-navy-100 rounded w-full mb-2"></div>
    ...
    <div v-else-if="csoProfiles.length > 0" class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        ...
        <p class="text-sm text-navy-700 line-clamp-2 mb-4">
          {{ cso.mission_statement || cso.description || 'No description' }}
        </p>
        ...
        <div class="flex items-center justify-between pt-4 border-t border-navy-100">
          <span class="text-sm text-navy-600">
            Experience: {{ cso.grant_experience_level || 'Not specified' }}
          </span>
    ...
    <div v-else class="text-center py-16">
      ...
      <h3 class="text-2xl font-display font-semibold text-navy-900 mb-2">No organizations yet</h3>
      <p class="text-navy-600 mb-6 max-w-md mx-auto">
        Create your first CSO profile to start discovering matching grants and funding opportunities.
      </p>
